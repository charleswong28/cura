...
export type ClientWithJobsFragment = {
  __typename?: "Client";
  id: string;
  name: string;
  industry?: string | null;
...
export type MyTenantsQuery = {
  __typename?: "Query";
  myTenants: Array<{ __typename?: "Tenant"; id: string; name: string; slug: string }>;
};
  ...
  definitions: [
    {
      ...
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "Candidate" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
export const ClientWithJobsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "ClientWithJobs" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "Client" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
} as unknown as DocumentNode<ClientWithJobsFragment, unknown>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: { kind: "NamedType", name: { kind: "Name", value: "CandidateStatus" } },
        },
        {
          kind: "VariableDefinition",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "status" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "ClientStatus" } },
        },
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "sortBy" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "FragmentSpread", name: { kind: "Name", value: "ClientWithJobs" } },
              ],
            },
          },
        ],

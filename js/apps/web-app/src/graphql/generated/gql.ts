...
export function graphql(
  source: "fragment CandidateFields on Candidate {\n  id\n  firstName\n  lastName\n  email\n  phone\n  currentCompany\n  currentTitle\n  location\n  status\n  notes\n  linkedinUrl\n  githubUrl\n  createdAt\n  updatedAt\n}"
 ...
 */
export function graphql(
  source: "query Candidates($first: Int, $after: String, $search: String, $status: CandidateStatus, $sortBy: String, $sortOrder: String) {\n  candidates(\n    first: $first\n    after: $after\n    search: $search\n    status: $status\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...CandidateFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Candidate($id: ID!) {\n  candidate(id: $id) {\n    ...CandidateFields\n  }\n}"
 ...
 */
export function graphql(
  source: "fragment ClientFields on Client {\n  id\n  name\n  industry\n  website\n  phone\n  address\n  status\n  createdAt\n  updatedAt\n}\n\nfragment ClientWithJobs on Client {\n  ...ClientFields\n  jobs {\n    id\n    title\n    status\n    priority\n  }\n}"
 ...
 */
export function graphql(
  source: "query Clients($first: Int, $after: String, $search: String, $status: ClientStatus, $sortBy: String, $sortOrder: String) {\n  clients(\n    first: $first\n    after: $after\n    search: $search\n    status: $status\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...ClientFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Client($id: ID!) {\n  client(id: $id) {\n    ...ClientWithJobs\n  }\n}"
): (typeof documents)["query Clients($first: Int, $after: String, $search: String, $status: ClientStatus, $sortBy: String, $sortOrder: String) {\n  clients(\n    first: $first\n    after: $after\n    search: $search\n    status: $status\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...ClientFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Client($id: ID!) {\n  client(id: $id) {\n    ...ClientWithJobs\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "fragment JobFields on Job {\n  id\n  title\n  description\n  status\n  priority\n  client {\n    id\n    name\n  }\n  assignedTo {\n    id\n    firstName\n    lastName\n  }\n  createdAt\n  updatedAt\n}"

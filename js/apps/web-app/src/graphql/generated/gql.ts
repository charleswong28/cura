...
type Documents = {
  ...
  "fragment ClientFields on ClientModel {\n  id\n  name\n  industry\n  website\n  phone\n  address\n  status\n  notes\n  bdUserId\n  parentId\n  activeJobCount\n  totalJobCount\n  createdAt\n  updatedAt\n}": typeof types.ClientFieldsFragmentDoc;
  "mutation CreateClient($input: CreateClientInput!) {\n  createClient(input: $input) {\n    ...ClientFields\n  }\n}\n\nmutation UpdateClient($id: ID!, $input: UpdateClientInput!) {\n  updateClient(id: $id, input: $input) {\n    ...ClientFields\n  }\n}\n\nmutation DeleteClient($id: ID!) {\n  deleteClient(id: $id) {\n    id\n    deletedAt\n  }\n}": typeof types.CreateClientDocument;
  "query Clients($first: Int, $after: String, $last: Int, $before: String, $filter: ClientFilterInput, $sortBy: ClientSortField, $sortOrder: SortOrder) {\n  clients(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    filter: $filter\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...ClientFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Client($id: ID!) {\n  client(id: $id) {\n    ...ClientFields\n  }\n}\n\nquery ClientTimeline($id: ID!) {\n  clientTimeline(id: $id) {\n    id\n    type\n    title\n    description\n    occurredAt\n    userId\n  }\n}": typeof types.ClientsDocument;
  "fragment JobFields on JobModel {\n  id\n  clientId\n  title\n  description\n  requirements\n  status\n  priority\n  ownerUserId\n  assignedToId\n  openDate\n  closeDate\n  applicationCount\n  interviewCount\n  offerCount\n  placementCount\n  createdAt\n  updatedAt\n}": typeof types.JobFieldsFragmentDoc;
  "mutation CreateJob($input: CreateJobInput!) {\n  createJob(input: $input) {\n    ...JobFields\n  }\n}\n\nmutation UpdateJob($id: ID!, $input: UpdateJobInput!) {\n  updateJob(id: $id, input: $input) {\n    ...JobFields\n  }\n}\n\nmutation DeleteJob($id: ID!) {\n  deleteJob(id: $id) {\n    id\n    deletedAt\n  }\n}\n\nmutation UpdateJobStatus($id: ID!, $status: JobStatus!) {\n  updateJobStatus(id: $id, status: $status) {\n    id\n    status\n    closeDate\n    updatedAt\n  }\n}\n\nmutation UpdateJobPriority($id: ID!, $priority: JobPriority!) {\n  updateJobPriority(id: $id, priority: $priority) {\n    id\n    priority\n    updatedAt\n  }\n}\n\nmutation AssignJob($id: ID!, $assignedToId: String) {\n  assignJob(id: $id, assignedToId: $assignedToId) {\n    id\n    assignedToId\n    updatedAt\n  }\n}": typeof types.CreateJobDocument;
 ...
 */
export function graphql(
  source: "fragment ClientFields on ClientModel {\n  id\n  name\n  industry\n  website\n  phone\n  address\n  status\n  notes\n  bdUserId\n  parentId\n  activeJobCount\n  totalJobCount\n  createdAt\n  updatedAt\n}"
): (typeof documents)["fragment ClientFields on ClientModel {\n  id\n  name\n  industry\n  website\n  phone\n  address\n  status\n  notes\n  bdUserId\n  parentId\n  activeJobCount\n  totalJobCount\n  createdAt\n  updatedAt\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "query Clients($first: Int, $after: String, $last: Int, $before: String, $filter: ClientFilterInput, $sortBy: ClientSortField, $sortOrder: SortOrder) {\n  clients(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    filter: $filter\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...ClientFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Client($id: ID!) {\n  client(id: $id) {\n    ...ClientFields\n  }\n}\n\nquery ClientTimeline($id: ID!) {\n  clientTimeline(id: $id) {\n    id\n    type\n    title\n    description\n    occurredAt\n    userId\n  }\n}"
): (typeof documents)["query Clients($first: Int, $after: String, $last: Int, $before: String, $filter: ClientFilterInput, $sortBy: ClientSortField, $sortOrder: SortOrder) {\n  clients(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    filter: $filter\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...ClientFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Client($id: ID!) {\n  client(id: $id) {\n    ...ClientFields\n  }\n}\n\nquery ClientTimeline($id: ID!) {\n  clientTimeline(id: $id) {\n    id\n    type\n    title\n    description\n    occurredAt\n    userId\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "fragment JobFields on JobModel {\n  id\n  clientId\n  title\n  description\n  requirements\n  status\n  priority\n  ownerUserId\n  assignedToId\n  openDate\n  closeDate\n  applicationCount\n  interviewCount\n  offerCount\n  placementCount\n  createdAt\n  updatedAt\n}"
): (typeof documents)["fragment JobFields on JobModel {\n  id\n  clientId\n  title\n  description\n  requirements\n  status\n  priority\n  ownerUserId\n  assignedToId\n  openDate\n  closeDate\n  applicationCount\n  interviewCount\n  offerCount\n  placementCount\n  createdAt\n  updatedAt\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "query Jobs($first: Int, $after: String, $last: Int, $before: String, $filter: JobFilterInput, $sortBy: JobSortField, $sortOrder: SortOrder) {\n  jobs(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    filter: $filter\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...JobFields\n        client {\n          id\n          name\n        }\n        assignedTo {\n          id\n          firstName\n          lastName\n          email\n        }\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Job($id: ID!) {\n  job(id: $id) {\n    ...JobFields\n    client {\n      id\n      name\n    }\n    assignedTo {\n      id\n      firstName\n      lastName\n      email\n    }\n    ownerUser {\n      id\n      firstName\n      lastName\n      email\n    }\n  }\n}"
): (typeof documents)["query Jobs($first: Int, $after: String, $last: Int, $before: String, $filter: JobFilterInput, $sortBy: JobSortField, $sortOrder: SortOrder) {\n  jobs(\n    first: $first\n    after: $after\n    last: $last\n    before: $before\n    filter: $filter\n    sortBy: $sortBy\n    sortOrder: $sortOrder\n  ) {\n    edges {\n      cursor\n      node {\n        ...JobFields\n        client {\n          id\n          name\n        }\n        assignedTo {\n          id\n          firstName\n          lastName\n          email\n        }\n      }\n    }\n    pageInfo {\n      hasNextPage\n      hasPreviousPage\n      startCursor\n      endCursor\n    }\n    totalCount\n  }\n}\n\nquery Job($id: ID!) {\n  job(id: $id) {\n    ...JobFields\n    client {\n      id\n      name\n    }\n    assignedTo {\n      id\n      firstName\n      lastName\n      email\n    }\n    ownerUser {\n      id\n      firstName\n      lastName\n      email\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
